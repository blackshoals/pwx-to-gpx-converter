...
#Integrates with gcpuploaderhttp://sourceforge.net/projects/gcpuploader/ to directly upload files to Garmin Connect after conversion
#Install gcuploader Linux:  sudo pip install GcpUploader Win: pip install GcpUploader and enter your Garmin Connect user name and password below
...
for subdir, dirs, files in os.walk(rootdir):
    for file in files:
		if file[-3:]=="pwx": #check if the file is a .pwx format
			...
			try:			#upload the files to Garmin Connect
				os.system("gupload.py -l "+gcuser+" "+gcpwd+" -a \'"+sportname+"\' \'"+targetfilename+"\'")
			except:
				pass
